...
- Architecture: bounded domain catalogs; polymorphic NPC hierarchy + concrete character classes; focused player/interaction/navigation/overlay/travel/quest/persistence services; `GameWorld` is composition-only.
