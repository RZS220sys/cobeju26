...
void fragment() {
	float patch = hash21(floor(world_position.xz * 0.28));
...
"""
	...
	var grass_texture := load("res://assets/adventure/textures/meadow_grass_v1.png") as Texture2D
	material.set_shader_parameter(&"grass_texture", grass_texture)
	var forest_texture := load("res://assets/adventure/textures/glasswood_floor_v1.png") as Texture2D
