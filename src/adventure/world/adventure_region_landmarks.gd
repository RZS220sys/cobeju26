...
var landmarks: Dictionary[StringName, AdventureWorldInteractable] = {}
...
func _build_glasswood_shrine() -> void:
	...
	_add_interactable(&"glasswood_shrine", "Listen at the Glasswood Shrine", center, "Glasswood Shrine")
...
func _build_amberfen_orrery() -> void:
	...
	root.add_child(core)
	_add_interactable(&"amberfen_orrery", "Turn the Amberfen Orrery", center, "Amberfen Orrery")
...
func _build_bellscar_bell() -> void:
	...
	_add_interactable(&"bellscar_bell", "Touch the silent Bellscar bell", center, "Bellscar Wake")
	_add_static_box(center + Vector3(0, 3.5, 0), Vector3(8.0, 7.0, 1.2))


@private
func _add_interactable(id_value: StringName, prompt: String, at: Vector3, node_name: String) -> void:
