...
func _build_interface() -> void:
	...
	_objective_panel.custom_minimum_size = Vector2(430.0, 72.0)
	...
	_interaction_panel.position = Vector2(-220.0, -105.0)
	_interaction_panel.size = Vector2(440.0, 58.0)
	...
	_dialogue_panel.position = Vector2(-470.0, -215.0)
	_dialogue_panel.size = Vector2(940.0, 105.0)
	...
	status.position = Vector2(28.0, 112.0)
	status.custom_minimum_size = Vector2(310.0, 78.0)
	...
	_lens_badge.position = Vector2(28.0, 202.0)
